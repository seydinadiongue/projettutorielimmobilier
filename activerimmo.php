...
<?php
		...
		echo "<span><input type='submit'  value='Désactiver' style='background:red;color:white;font-weight:bold;width:120px;height:40px;border-radius:20px;font-size:20px; ' />	</span>
		</form>";
		}
		else
		{
		...
		echo "<span><input type='submit'  value='Activer' style='background:green;color:white;font-weight:bold;width:120px;height:40px;border-radius:20px;font-size:20px; ' />	</span>
		</form>";
		 }       
