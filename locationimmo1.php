...
<img id ='b' src  ="im1.png"/>
		...
		<section id='span'>
        <a  class="gf" href="reservationimmo1.php" >Réservations </a>
		<a id="kal" class="gf" href="locationimmo1.php" >location </a>
		<a  class="gf" href="bienimmo1.php" > Biens</a>
		<a class="gf" href="agentimmo.php" > Gestion Agents</a>
		<a class="gf" href="clientimmo.php" > Gestion Clients</a>
		<a class="gf" href="ajoutimmo1.php"> Ajout de bien </a>
		</section>
